...
<head>
    ...
    <meta name="description" content="{{ $seo ? $seo->meta_description : 'Default description here' }}">
    <meta name="author" content="{{ $seo ? $seo->meta_author : 'Default Author' }}">
    <meta name="keywords" content="{{ $seo ? $seo->meta_keyword : 'Default, Keywords' }}">
    <meta name="robots" content="all">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <title>@yield('title')</title>
    <!-- /// Google Analytics Code // -->
    <script>
       {{ isset($seo) && !is_null($seo->google_analytics) ? $seo->google_analytics : 'Default Google Analytics Code' }}
...
<script type="text/javascript">
    function wishlist(){
            ...
            success:function(response){
                ...
                $.each(response, function(key,value){
                    ...
                    <td class="col-md-7">
                        ...
                        :
                        `${value.product.discount_price} <span>${value.product.selling_price} EGY</span>`
                    }
                        </div>
                    </td>
        <td class="col-md-2">
        ...
        <td class="col-md-1 close-btn">
            <button type="submit" class="" id="${value.id}" onclick="wishlistRemove(this.id)"><i class="fa fa-times text-danger"></i></button>
        </td>
                </tr>`
                });
            ...
            success:function(response){
                ...
                <td class="col-md-2">
                 ...
                 <td class="col-md-2">
                  ...
                  <td class="col-md-2">
                    <strong>${value.subtotal} EGY</strong>
                  </td>
