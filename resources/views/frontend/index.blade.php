                                                    ...
                                                    <div class="col col-xs-7">
                                                        <div class="product-info">
                                                            ...
                                                            <div class="product-price"> <span class="price">
                                                                    {{ $product->selling_price }} EGY</span>
                                                            </div>
                                                            <!-- /.product-price -->
                                                        </div>
                                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="hidden-md col-sm-4 col-lg-4">
                                    <div class="info-box">
                                        ...
                                        <h6 class="text">Shipping on orders over 99 Egy</h6>
                                    </div>
                                </div>
                                <!-- .col -->
                                ...
                                <div class="col-md-6 col-sm-4 col-lg-4">
                                    <div class="info-box">
                                        ...
                                        <h6 class="text">Extra 5 Egy off on all items </h6>
                                    </div>
                                </div>
                                <!-- .col -->
                            </div>
                            ...
                            <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
                                <li class="active">
                                    <a data-transition-type="backSlide" href="#all" data-toggle="tab">
                                        @if(session()->get('language') == 'arabic')  {{ __('الكل') }} @else  {{ __('All') }} @endif
                                    </a>
                                </li>
                                    ...
                                    <div class="item">
                                        <div class="blog-post">
                                            ...
                                            <div class="blog-post-info text-left">
                                                <h3 class="name"><a href="#">@if(session()->get('language') == 'arabic') {{ $blog->post_title_ar }}
