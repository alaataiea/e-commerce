...
<head>
    ...
    <title>EgyShop Admin - Log in </title>
                ...
                <div class="col-lg-4 col-md-5 col-12">
                    ...
                    <div class="p-30 rounded30 box-shadowed b-2 b-dashed">
                        <form method="POST" action="{{ isset($guard) ? url($guard.'/login') : route('login') }}">
                            ...
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    ...
                                    <input id="email" type="text" class="form-control pl-15 bg-transparent text-white plc-white"
                        ...
                        <div class="text-center text-white">
                            ...
                            <a class="btn btn-social-icon btn-round btn-outline btn-white" href="{{url('auth/google')}}"><i class="fa fa-google">  sign in with google</i></a>    
                            </p>
